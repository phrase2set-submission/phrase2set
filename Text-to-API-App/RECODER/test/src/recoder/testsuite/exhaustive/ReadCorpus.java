...
public class ReadCorpus extends RecoderTestCase {
	...
	private static final String PATH_TO_CORPUS = "c:/libs_and_tools/qualitas_refined/"; 
	private static final String PATH_TO_JDK_6 = "C:/Program Files (x86)/Java/jdk1.6.0_38/";
	private static final String PATH_TO_JDK_5 = "C:/Program Files (x86)/Java/jdk1.5.0_22/";
	private static final String PATH_TO_JDK_1_4 = "C:/Program Files (x86)/Java/jdk.1.4.2_19/";
	...
	private void doIt(String projectName, int javaVersion) throws Exception {
		...
		if (RUN_TRANSFORMATIONS) {
			Backport.main(inputPath, "e:/temp/");
