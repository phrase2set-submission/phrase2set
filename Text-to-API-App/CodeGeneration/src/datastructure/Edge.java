...
//	}
	...
	public synchronized long getRepValue(){
		if (sourceNode==null)
			return 0l;
		if (sinkNode==null)
			return 0l;
		return ((long)sourceNode.content)*4294967296L + (long)sinkNode.content;
	}
	...
	public boolean partRoleEquals(Object obj) {
		...
		if (sinkNode == null) {
			if (other.sinkNode != null)
				return false;
		} else if (!sinkNode.partRoleEquals(other.sinkNode))
			return false;
		if (sourceNode == null) {
			if (other.sourceNode != null)
				return false;
		} else if (!sourceNode.partRoleEquals(other.sourceNode))
			return false;
		return true;
	}
